...
Pathology Laboratory, BARC Hospital, Anusaktinagar, Mumbai – 400094
NABL Accredited Medical Laboratory
...
- **Host:** localhost (intranet-only)
- **Database:** `nabl_import`
- **User:** `labuser`
- **Charset:** `utf8mb4` / `utf8mb4_unicode_ci`
- **Connection type:** MySQLi object-oriented interface

Primary tables: `patient_master`, `lab_order`, `lab_service_master`, `specimen_master`, `his_user`
...
*Pathology Laboratory, BARC Hospital | NABL Accredited Medical Laboratory*
